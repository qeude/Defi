...
extension Daemon {
  func status() -> String {
    ...
    return
      ...
      + " observerCoverage=\(observationCoverage.applicationObservers)/\(observationCoverage.applications):\(observationCoverage.topologyWindows)/\(observationCoverage.frameWindows)/\(observationCoverage.windows)"
